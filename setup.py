...
setup(
    ...
    author='maxme1, vovaf709, talgat, alexeybelkov, AnihilatorGun',
    author_email='max@aumi.ai, vovaf709@yandex.ru, saparov2130@gmail.com, fpmbelkov@gmail.com, nikitaushakov.nu35@gmail.com',
    license='MIT',
