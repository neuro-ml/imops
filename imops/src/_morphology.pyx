...
def old_binary_dilation(np.uint8_t[:, :, :] input, np.uint8_t[:, :, :] footprint, Py_ssize_t num_threads):
...
def old_binary_erosion(np.uint8_t[:, :, :] input, np.uint8_t[:, :, :] footprint, Py_ssize_t num_threads):
    cdef np.uint8_t[:, :, ::1] contiguous_input = np.ascontiguousarray(input)
    cdef np.uint8_t[:, :, ::1] contiguous_footprint = np.ascontiguousarray(footprint)
